     ...
     goverments &&  Object.keys(goverments).map((element)=>{
       ...
       return(
        ...
        <CardActions>
         ...
         {element.toString().toLowerCase() === 'kiev' ? <NavLink class="cardLink" to="/cityKiev">See More</NavLink> : null}
         {element.toString().toLowerCase() === 'warsaw' ? <NavLink class="cardLink" to="/cityWarsaw">See More</NavLink> : null}
         {element.toString().toLowerCase() === 'new york' ? <NavLink class="cardLink" to="/cityNewYork">See More</NavLink> : null}
          </Button>
        </CardActions>
      </Card>
